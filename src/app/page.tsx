        ...
        <div className="mx-auto max-w-3xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link
                href="/planit"
                className="rounded-md bg-yellow-400 px-3.5 py-2.5 text-sm font-semibold text-gray-600 shadow-sm hover:bg-yellow-500 hover:text-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-400"
              >
                Get started
              </Link>
